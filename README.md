...
React JS is a JS library used to build user interfaces or UI components to reuse code easily and handle dynamic data automatically faster.

1. Describe component state.

An object that can holding changing information 

1. Describe props.

a keyword that passes data from component parent to a child component

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

side effects are effects that happen outside what was coded. effects in React can sync with changes of certain state or props through useEffect() which takes the changes of certain state or props and for example displays them while auto updating according to anymore changes.
